...
export const LINE_DEFS: LineDef[] = [
  ...
  { id: 'arc.offer.lhm', lang: 'arc', intent: 'offer', words: ['arc:lḥm'], roles: ['baker', 'grinder', 'mason'],
    gloss: 'Bread.', phraseTier: 'C', usageTier: 'C', src: 'lexicon arc:lḥm', note: 'offering or naming bread: at the oven, or passed round at the gang\'s midday meal at the site (D-080; C)' },

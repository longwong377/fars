...
export const SETTLEMENT_SURFACES: Record<string, SurfaceDef> = {
  ...
  house_plaster: { albedo: [0.56, 0.47, 0.36], roughness: 0.95, porosity: 0.85, noiseScale: 0.9, noiseAmp: 0.1, tone: { sd: 0.07, chroma: 0.012, patch: -0.05 }, foot: 1, skirt: { h: 0.45, dark: 0.12, salt: 0.15 }, runoff: 0.12, plasterWork: { float: 1, cracks: 1 }, bump: { amp: 0.008, freq: 1.4 }, micro: { amp: 0.0007, freq: 50, alb: 0.06 }, top: 'house_roof', tier: 'C', note: 'town house walls: straw-tempered mud plaster over mud brick (earthen plaster B: Stein et al. 2016; tone per house C), a renewed skirting coat with damp and salt at the foot, float arcs, shrinkage cracks, run-off under the tops (D-218 model, C)' },

...
export const SETTLEMENT_SURFACES: Record<string, SurfaceDef> = {
  ...
  mud_plaster: { albedo: [0.56, 0.47, 0.36], roughness: 0.95, porosity: 0.85, noiseScale: 0.7, noiseAmp: 0.09, bump: { amp: 0.006, freq: 1.2 }, top: 'mud_roof', tier: 'C', note: 'town walls: mud plaster (straw-tempered loam) over mud brick, local soil tone (C; no excavated Persepolis house)' },
  ...
  baked_brick: { albedo: [0.62, 0.5, 0.36], roughness: 0.85, porosity: 0.5, noiseScale: 1.5, noiseAmp: 0.1, joints: { course: 0.09, block: 0.34, width: 0.03 }, bump: { amp: 0.002, freq: 5 }, top: 'mud_roof', tier: 'B/C', note: 'baked-brick facing of the Tol-e Ajori gate (materials B: AJORI-BRICK2018; brick size and tone C)' },
  ...
  takht_stone: { albedo: [0.52, 0.5, 0.46], roughness: 0.7, porosity: 0.35, noiseScale: 1.3, noiseAmp: 0.12, joints: { course: 1.1, block: 2.6, width: 0.01 }, bump: { amp: 0.002, freq: 5 }, tier: 'C', note: 'Takht-e Rustam: local stone (LIVIUS-TR, B); block size C' },

...
export interface Gig { id: string; kind: 'quern_song' | 'mason_song' | 'court_supper' | 'court_night' | 'herder_pipe' | 'women_drum'; place: string; parts: GigPart[]; claims: string[]; tier: string;

...
export const INSCRIPTION_INFO: Record<string, { title: string; where: string; carved: string }> = {
  ...
  XPc: { title: 'XPc — Xerxes, Tachara', where: 'between the guards of the central façade of the Tachara S stair (B; the arrangement C), and on the eastern and western antae of the S portico, on the face turned to the portico (B; the face, the field and the dark-stone casing C: D-214)', carved: `${ALL3}, stacked` },
  ...
  XPd: { title: 'XPd — Xerxes, Hadish', where: 'between the guards of the central façade of the Hadish W stair (B; position and arrangement C), and on the two antae of the N portico, drawn as free-standing stone piers (B; the piers, the face and the field C: D-214)', carved: `${ALL3}, stacked` },
  ...
  DPb: { title: 'DPb — Darius I', where: 'above the king on the reveals of the Hadish NW doorway (the doorway and the stacking C), and in one line across the robe of the king on the Tachara S main doorway (B: on the garment of Darius in his palace; which relief and where on the robe C: D-214)', carved: `${ALL3}, stacked (above the king); the Old Persian alone on the garment` },
  XPg: { title: 'XPg — Xerxes, Apadana', where: 'on a plaque of dark stone beside the Apadana\'s N doorway, inside the N portico (B: an ornamental plaque of the Apadana; its place, size and stone C: D-214). Its copies on glazed bricks are not drawn', carved: 'Old Persian (the edition has no other version)' },
  XPj: { title: 'XPj — Xerxes, column bases', where: 'round the drums of the six bases of the front row of the Hadish N portico (B: column bases of the Queen\'s Quarters or the Palace of Xerxes; which bases C: D-214)', carved: `${ALL3}, one line each round the drum, stacked` },
  XPk: { title: 'XPk — Xerxes, his garment', where: 'in one line across the robe of the king on the Hadish E doorway (B: on Xerxes\' garment on a relief; which relief and where on the robe C: D-214)', carved: `${ALL3}, one line each, stacked` },
  XPm: { title: 'XPm — Xerxes, column bases', where: 'round the drums of the six bases of the back row of the Hadish N portico (B: fragments of column bases; which bases C: D-214)', carved: `${ALL3}, one line each round the drum, stacked` },

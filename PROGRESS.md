...
- **Phase 6 (settlement; merged in session 3, D-041 to D-044):**
  ...
  - Weak or unverified:
    ...
    - **The houses are placeholders** (flagged in F3 since D-228): their walls, roofs and street-door leaves are plain box slabs, and the street doors stand open and never move. The plan itself (plots, rooms, courts, lanes) is the C reconstruction. The town's trees are on the tree kit since D-122 and are no longer placeholders.

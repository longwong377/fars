...
| 14 | A published English translation of the Xerxes inscriptions XPa, XPb, XPc, XPd (and XPe) under a licence allowed by USE (public domain, e.g. H. C. Tolman, *Ancient Persian Lexicon and the Texts of the Achaemenidan Inscriptions*, 1908; or CC-BY/CC-BY-NC, e.g. ORACC ARIo translations) | a PDF/text of the translation, with its licence | `data/sources/translations/` | The translation layer shows transliterations (ARIo, CC0) and word glosses from the lexicon only: ORACC, Livius and archive.org are blocked here, and no translation is paraphrased from memory (§4.1). |

...
const SHOTS: { n: string; day: number; hour: number; w: string; v: [number, number, number, number, number]; fov?: number; frames?: number; court?: boolean; carry?: [string, number]; now?: boolean; ab?: { tag: string; hide: string[] } }[] = [
  ...
  // session 9 (T-J5): a sporadic meteor (src/sky/meteors.ts; seed 1) mid-flight on a moonless night: day 154 at 01:55:37.5
  ...
  { n: 'scribe-at-work', day: 21, hour: 13.5, w: 'clear', v: [184.1, -82.9, 1.05, 76, -10], fov: 50 }, // (D-221: 0.3 m back from 184.4, where the rig's 2.5 m clearance hid the Elamite scribe 2.42 m away; NOT re-rendered)

// Human asset build (D-016): the generated MakeHuman-derived assets are complete, skinned to the shared skeleton with
...
describe('human assets (MakeHuman CC0, D-016)', () => {

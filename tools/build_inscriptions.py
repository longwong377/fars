...
def main():
    ...
    IDS = {'XPa': 'Q007209', 'XPb': 'Q007210', 'XPc': 'Q007211', 'XPd': 'Q007212', 'XPe': 'Q007213', 'DNa': 'Q007152', 'DNb': 'Q007153'}  # DNa/DNb: Darius I's tomb, Naqsh-e Rustam (identified by content: DNa 'Ariyaciça', 'gāθum', 'patikarā'; DNb 'ima frašam ... upari Dārayava.um')
    res = {}
    for sig, q in IDS.items():
        ...
        # XPe (titulary only) has no god line: its Babylonian opens with the king's name {m}hi-ši-ʾ-ar-ši
        b = re.search(r'\bDINGIR\b|\bAN GAL\b|\bil-lu\b', rest) or re.search(r'\{m\}hi-ši-ʾ-ar-ši', rest)

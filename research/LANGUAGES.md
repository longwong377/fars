...
| **XPg** | Apadana | "on an ornamental plaque and on many glazed bricks" | OP | Xerxes completed works ordered by Darius. ARIo XPg = Q007215 (Xerxes I 11; Old Persian only). Carved on its plaque since D-214 (placement C) | A / B |
...
| **XPj / XPm** | Hadish / Harem | column bases, "found in the Queen's Quarters, but several may be from Palace of Xerxes" | OP, El, Bab | "I built this palace". ARIo XPj (Q007218) and XPm (Q007221) read *imam tacaram adam akunavam*; Elamite *hi ta₂-iz-za-ra*, Babylonian *E₂ ta-aš₂-ša₂-ri*, so Xerxes also called his palace *tacara*. Carved round the Hadish N portico's base drums since D-214 (C, Q-422) | A text / B placement |
| **XPk** | Hadish? | "on Xerxes' garment on a relief" | OP, El (ARIo XPk = Q007219, Xerxes I 15, also has a Babylonian line: Q-423) | "Xerxes, son of king Darius". Carved on the Hadish E doorway king's robe since D-214 (C) | B |

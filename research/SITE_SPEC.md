...
| r_windows | {"S": [-4.69, 4.69]} | m | WP-EXT;RECON | C | two windows in the hall S wall, one either side of the main doorway, centred in the free wall between the door frame and the hall corner (C; RECOLLECTION of window frames flanking the Tachara doorway, NOT SEEN; Q-087) |
| r_niches | {"N": [0.0], "E": [-3.86, 3.86], "W": [-3.86, 3.86]} | m | WP-EXT;RECON | C | blind niches on the inner faces of the walls to the side rooms: N wall between the two doorways, E and W walls on the aisles between the column rows (C; Q-087) |
| r_door_state | {"S_main": "open", "N_W": "open", "N_E": "open"} |  | RECON | C | palace doors stand open by day and can be closed; people open a closed door as they pass (C, D-051) |
| door_jamb_reliefs | {"S_main": {"programme": "king", "attendants": ["parasol", "whisk"], "tier": "B", "note": "king with attendants on the main doorway (WP-EXT, B); a parasol- and a fly-whisk-bearer (C, as on the Harem S door)"}, "N_W": {"programme": "hero", "beasts": ["lion", "monster"], "tier": "B", "note": "royal hero vs lion / monster (WP-EXT, B); which doorway and jamb C"}, "N_E": {"programme": "attendants", "props": ["towel", "flask"], "tier": "B", "note": "attendants with towel and perfume flask (ISAC-PA, WP-EXT: B); which doorway C"}} |  | WP-EXT;ISAC-PA;RECON | B/C | jamb programme of the Tachara doorways (B motifs; assignment to the modelled doorways C). The lance-bearers with wicker shields of the W rooms (B) have no modelled doorway (the hall W wall has none in the model) and are not placed |
...
| door_jamb_reliefs | {"N_W": {"programme": "king", "attendants": ["parasol", "towel"], "tier": "B", "note": "king with parasol- and towel-bearers, labelled \"Darius the king\" (FARROKH/SI-ARCH, B)"}, "N_E": {"programme": "king", "attendants": ["parasol", "towel"], "tier": "C", "note": "NOT FOUND: reconstructed as the NW doorway (C, analogue)"}, "E": {"programme": "king", "attendants": ["parasol", "whisk"], "tier": "B", "note": "king and attendants with XPe above (SI-ARCH, B); XPe is not in inscriptions.json and is not carved (C)"}, "W": {"programme": "king", "attendants": ["parasol", "whisk"], "tier": "C", "note": "XPe on the W doorway (FARROKH, B); the figures reconstructed as the E doorway (C, analogue)"}, "S": {"programme": "plain", "tier": "C", "note": "no programme found for the balcony doorway: left plain"}} |  | FARROKH;SI-ARCH;RECON | B/C | jamb programme of the Hadish hall doorways |
...
| CDLI-PF | R. T. Hallock, Persepolis Fortification Tablets (OIP 92, 1969): PF 1-60 and 400-406, transliterations and Hallock's English translations as carried by CDLI (P382687-P382746, P383086-P383092) https://media.githubusercontent.com/media/cdli-gh/data/master/cdliatf_unblocked.atf | downloaded; the 67 texts read in full (FT). Darius-era (years 16-28). The only PF texts read in full |
...
| EWB | W. Hinz & H. Koch, Elamisches Wörterbuch (1987), lemma and sense base digitised by DANES-ALP (DigitalPasts/ALP-MEGA2024, commit 3160b20, js/data/senses.js) https://github.com/DigitalPasts/ALP-MEGA2024 | downloaded; glosses and page refs read (FT). No licence in the repo: facts only, not redistributed |
...
| HDT-GRC | Herodotus, Histories, Greek text ed. A. D. Godley (Loeb), Perseus canonical-greekLit tlg0016.tlg001.perseus-grc2 (CC BY-SA) https://github.com/PerseusDL/canonical-greekLit/blob/master/data/tlg0016/tlg001/tlg0016.tlg001.perseus-grc2.xml | downloaded (FT; sha256 1bc02351…05f0bfd); forms searched by book.chapter.section. Herodotus writes Ionic prose (mid-5th c.); the manuscript tradition normalises the dialect in places |
| HOM-OD | Homer, Odyssey, Greek text (Perseus canonical-greekLit tlg0012.tlg002.perseus-grc2, CC BY-SA) https://github.com/PerseusDL/canonical-greekLit/tree/master/data/tlg0012/tlg002 | downloaded (FT); Od. 1.123 χαῖρε, ξεῖνε |
| LSJ | H. G. Liddell, R. Scott, H. S. Jones, A Greek-English Lexicon (1940), Perseus TEI edition (PerseusDL/lexica, CC BY-SA) https://github.com/PerseusDL/lexica/tree/master/CTS_XML_TEI/perseus/pdllex/grc/lsj | downloaded (FT); first renderings of each lemma compared with the glosses |
...
| RIBO | ORACC RIBo, Royal Inscriptions of Babylonia online (Neo-Babylonian royal inscriptions, 7th-6th c.), raw ATF via GitHub mirror SLAB-NLP/Akk data/jsonl/ribo.jsonl https://github.com/SLAB-NLP/Akk | downloaded (FT, text only without lemmatisation or translation); ORACC project licence not checked |
| CAMS-ORACC | ORACC CAMS (Corpus of Ancient Mesopotamian Scholarship and related Late Babylonian texts), raw ATF via GitHub mirror SLAB-NLP/Akk data/jsonl/cams.jsonl https://github.com/SLAB-NLP/Akk | downloaded (FT, text only) |
| HBTIN | ORACC HBTIN (Hellenistic Babylonia: Texts, Images and Names; Late Babylonian legal texts from Uruk), raw ATF via GitHub mirror SLAB-NLP/Akk data/jsonl/hbtin.jsonl https://github.com/SLAB-NLP/Akk | downloaded (FT, text only); later than 467 (Hellenistic) |

...
| rooms | each room by use (C): a store (jars and sacks on the back wall), a living room (a reed mat, bedding rolled against the wall, folded rugs, a clay saucer lamp on a mud ledge), the vestibule (a bench); a lamp lit in the evening and before dawn in every house (the fire system's lamp, 'home' schedule) | saucer lamps B by analogy (Q-516); who burned oil each evening C (Q-560) | RECON | C |
| doorway variety | per street door: the lintel up to 15 cm under the 2 m head, its depth and bearing, a doorstep (40 %), a lamp niche (75 %, its size and place), timber jamb boards (better-off, ~35 %) or a raised plaster surround (~30 %) | — | RECON | C |
| seasons | sleeping mats on the roofs from mid-May to mid-September; the household's grain spread to dry on half the roofs after the harvest (mid-May to early July) | the region's summer nights on the roof (RECOLLECTION) | RECON | C |

...
| E-41 | 1–3 (mid-May – June) | **Barley harvest** | whole households; hired or assigned kurtaš (C) | fields | – | daily in the window | FARS-CROP ("winter barley … harvested between May and July") | B (modern) / C |
| E-42 | 2–4 (late May – late July) | **Wheat harvest** | as E-41 | fields | – | daily in the window | FARS-CROP ("wheat harvest late May to late July"; rainfed mid-July) | B (modern) / C |
| E-43 | 3–5 | **Threshing and winnowing; grain carried to stores** | households, grain handlers | threshing floors; then E-06 | – | daily in the window | inference from E-41/42; OP month 5 is "harvest (month)" (WP-CAL, SX); PF 6 delivery in months 4–6 (FT) | C |
...
| E-64 | 3–5 | **Summer heat**: midday rest on the building sites (Tmax 36–38 °C) | all outdoor workers | – | – | daily | climate (A); the rule is C | C |

...
| E-72 | **Sickness episode** | 1,000–2,000 episodes (1–2 per person-year); peak in summer (gut) and winter (chest) | a day or more off work; stays home; since D-211 a healer of the quarter (a woman of 40–65) calls in the morning at the houses near her own where someone lies ill in the second day or more of an illness of three days or more, with herbs and a poultice (the Babylonian *asû* as the analogy) | no source | C (Q-039) |
| E-73 | **Marriage** | 8–10; about half in the fifty days round the turn of the year and the spring equinox (C; Strabo 15.3.17, **RECOLLECTION, NOT SEEN**) | the ceremony is **silent** for Persepolis; since D-211 (D-207) the most probable reconstruction is shown: the women of the bride's house carry the dowry through the lanes to the groom's house, the bride with them; a feast with the kin of both houses in the groom's courtyard from midday to dusk (indoors in rain); at dusk the women sing and beat the frame drum and clap (wordless, M-22); the bride stays in her new house. Dowries and the bride's move are attested for Babylonia (ROTH1987, B) | ROTH1987 (SX); RECON | C |
| E-74 | **Dispute** (over a ration shortfall, a place in the queue, a borrowed tool) | 50–150 small disputes; escalation to an official is rare | voices raised at the store or on the site; since D-211 one in eight is heard before an official at the official building the next morning, a witness each, and settled by a pledge or a share of the ration (Babylonian judges at the gate: analogy B); no punishment is shown | no PF or PT dispute text was retrieved | C |

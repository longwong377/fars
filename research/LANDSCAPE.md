...
- **Naqsh-e Rustam ancient ground (Phase 7, D-037):** "the original floor at the foot of the cliff was, at least, 5 m below the present-day ground" (Iranica "Naqš-e Rostam", search extract, B). Layer 5 lowers the mid ring in front of the cliff face line (plain.json `naqsh_e_rustam.cliff`: grid y 6,124, x 432-932, from the raw DSM's 1,635-1,660 m contours, C) by 5 m at the foot, tapering to 0 at 250 m (C), flattens the DSM's smeared cliff foot, and holds two cells behind the face at the ancient level (inside the rock, under the cliff mesh). Present foot 1,627.5 m, ancient foot 1,622.5 m asl; 595 samples. The terrain spot check "Naqsh-e Rustam cliff foot ~1,630 m +-15" still passes (it is the present-day value; the SRTM check excludes that point).

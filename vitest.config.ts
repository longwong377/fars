...
export default defineConfig({ test: { include: ['tests/**/*.test.ts'], exclude: ['**/node_modules/**', '**/.claude/**', ...gate], testTimeout: 120000, fsModuleCache: true } }); // fsModuleCache: transforms kept on disk between runs (D-251)
